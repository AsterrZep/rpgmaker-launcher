...
Place .zip files next to the launcher and click Refresh.`,dragDropZip:"Drop .zip files here to add them!",navPlay:"Library",navPlugins:"Plugins",navSaves:"Saves",navData:"Data",navMods:"Mods",navSync:"Sync",navDecrypt:"Decrypt",navShortcuts:"Shortcuts",navQuit:"Quit",navSettings:"Settings",btnPlay:"Play",btnStopServer:"Stop Server",btnRefresh:"Refresh",btnSave:"Save Changes",btnCancel:"Cancel",btnClose:"Close",btnBackup:"Backup",btnRestore:"Restore",btnExport:"Export",btnDelete:"Delete",btnEnableAll:"All ON",btnDisableAll:"All OFF",btnPush:"Push to Destination →",btnPull:"← Pull from Destination",btnChangeFolder:"Change...",btnOpenFolder:"Open Folder",toggleWebKit:"WebKit",toggleDelZip:"Delete .zip",toggleWebKitTip:"Use the WebKit viewer (lighter) instead of the browser",toggleDelZipTip:"Delete the .zip after extracting",updateChipTip:"New version available. Click to view releases.",modsReadyToast:"Mods folder ready and opened. Every .js is injected on launch; reload with F5.",quitTip:"Close the launcher",settingsTitle:"Settings",settingsDesc:"Choose the folder where games and .zip files will be stored.",settingsGamesFolder:"Games folder:",settingsDefaultFolder:"Default: %s",playedHours:"played",playedNow:"Played just now",playedMin:"Played %d min ago",playedHoursAgo:"Played %d h ago",playedDaysAgo:"Played %d d ago",neverPlayed:"Not played yet",incompleteBadge:"Incomplete",incompleteNotice:"Incomplete download (missing files)",serverActive:"Active Server:",serverPort:"Port",serverStopped:"Server stopped",runtimeReady:"RPG Maker Engine Runtime v{version}",pluginsTitle:"Plugins",pluginsDesc:"Manage and analyze WebKit / nw.js compatibility",savesTitle:"Save Manager",savesDesc:"Backups, snapshots, and save editing",saveEditorTitle:"Save Editor",saveEditorWarning:"⚠ Close the game before editing: autosaves might overwrite your changes.",saveEditorGold:"Party Gold",saveEditorItems:"Items",saveEditorVariables:"Variables",saveEditorSwitches:"Switches",saveEditorGeneral:"General",dataTitle:"Database Browser",syncTitle:"Save Sync",syncDestFolder:"Destination folder:",syncAutoToggle:"Automatically sync saves when closing a game",decryptTitle:"Decryption Tool",decryptNotice:"Decrypts .rgssad/.rgss2a/.rgss3a and RPG Maker MV/MZ encrypted assets.",shortcutsTitle:"Shortcuts & Preferences",toastServerStarted:"Server started on port %d",toastServerStopped:"Server stopped (%d sec played)",toastSaved:"Save file updated successfully",toastSyncDone:"Sync completed",toastBackupDone:"Backup created"}};let v="es";function $(){return v}function y(b){v=b,document.documentElement.lang=b}function o(b,...e){let a=(f[v]||f.es)[b]||f.es[b]||b;return e.length>0&&e.forEach(r=>{a=a.replace(/%[ds]/,String(r))}),a}class q{constructor(e){c(this,"activeTab","library");c(this,"callbacks");this.callbacks=e}setActiveTab(e){this.activeTab=e,this.render()}render(){const e=document.createElement("aside");return e.className="fixed left-0 top-0 h-full w-60 bg-surface-container-lowest z-30 flex flex-col border-r border-border select-none",e.innerHTML=`
    ...
    `;const a=e.querySelector("#search-input");let r;a==null||a.addEventListener("input",m=>{const g=m.target.value;window.clearTimeout(r),r=window.setTimeout(()=>{this.callbacks.onSearch(g)},150)}),(i=e.querySelector("#btn-refresh-zips"))==null||i.addEventListener("click",()=>{this.callbacks.onRefresh()}),(l=e.querySelector("#btn-lang"))==null||l.addEventListener("click",()=>{const m=$()==="es"?"en":"es";y(m),this.callbacks.onLanguageChange(m)}),(d=e.querySelector("#btn-settings"))==null||d.addEventListener("click",()=>{this.callbacks.onSettingsClick()}),(n=e.querySelector("#toggle-webkit"))==null||n.addEventListener("change",m=>{this.webkit=m.target.checked,this.callbacks.onToggleWebKit(this.webkit)}),(h=e.querySelector("#toggle-del-zip"))==null||h.addEventListener("change",m=>{this.autoDeleteZip=m.target.checked,this.callbacks.onToggleDelZip(this.autoDeleteZip)});const s=e.querySelector("#update-chip");return s==null||s.addEventListener("click",()=>this.callbacks.onUpdateClick()),e}}class j{constructor(e,t,a){c(this,"game");c(this,"isSelected");c(this,"callbacks");c(this,"_el",null);this.game=e,this.isSelected=t,this.callbacks=a}formatLastPlayed(e){if(!e)return o("neverPlayed");const t=Date.now()/1e3-e;return t<60?o("playedNow"):t<3600?o("playedMin",Math.floor(t/60)):t<86400?o("playedHoursAgo",Math.floor(t/3600)):t<7*86400?o("playedDaysAgo",Math.floor(t/86400)):new Date(e*1e3).toLocaleDateString()}formatHours(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60);return t>0&&a>0?`${t}h ${a}m`:t>0?`${t}h`:a>0?`${a}m`:"0m"}getEngineBadgeClass(e){switch(e){case"MZ":return"bg-accent-soft text-primary";case"MV":return"bg-secondary-container text-on-secondary-container";case"XP":case"VX":case"VXAce":return"bg-surface-variant text-text-muted";case"renpy":return"bg-status-success/20 text-status-success";default:return"bg-surface-variant text-text-muted"}}render(){const e=document.createElement("div");this.game.is_incomplete,this.applySelectionClass(e);const t=this.game.cover_url?`${u.getBaseUrl()}${this.game.cover_url}`:null,a=t?`<img class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" src="${t}" alt="${this.game.name}" loading="lazy" decoding="async" draggable="false" />`:`<div class="w-full h-full flex items-center justify-center bg-surface-container-high text-primary font-black text-3xl select-none">${this.game.name.charAt(0).toUpperCase()}</div>`;e.innerHTML=`
      <!-- Favorite Star Badge -->
    ...
    `,(r=e.querySelector("#btn-play"))==null||r.addEventListener("click",()=>this.callbacks.onPlay()),(s=e.querySelector("#btn-plugins"))==null||s.addEventListener("click",()=>this.callbacks.onPlugins()),(i=e.querySelector("#btn-saves"))==null||i.addEventListener("click",()=>this.callbacks.onSaves()),(l=e.querySelector("#btn-data"))==null||l.addEventListener("click",()=>this.callbacks.onData()),(d=e.querySelector("#btn-mods"))==null||d.addEventListener("click",()=>this.callbacks.onMods()),(n=e.querySelector("#btn-sync"))==null||n.addEventListener("click",()=>this.callbacks.onSync()),(h=e.querySelector("#btn-decrypt"))==null||h.addEventListener("click",()=>this.callbacks.onDecrypt()),(m=e.querySelector("#btn-stop-server"))==null||m.addEventListener("click",()=>this.callbacks.onStopServer()),(g=e.querySelector("#btn-shortcuts"))==null||g.addEventListener("click",()=>this.callbacks.onShortcuts()),(x=e.querySelector("#btn-quit"))==null||x.addEventListener("click",()=>this.callbacks.onQuit()),e}}class _{constructor(){c(this,"activeGame",null);c(this,"activePort",null);c(this,"version","0.0.0")}setVersion(e){this.version=e,this.render()}update(e,t){this.activeGame=e,this.activePort=t,this.render()}render(){const e=document.createElement("footer");e.className="h-7 shrink-0 w-full bg-surface-container-lowest border-t border-border flex items-center justify-between px-6 select-none text-[11px]";const t=G(this.activeGame&&this.activePort);return e.innerHTML=`
      <div class="flex items-center gap-2">
    ...
    `,e}}function G(b){return!!b}class O{constructor(){c(this,"container");this.container=document.createElement("div"),this.container.className="fixed bottom-12 right-6 z-50 flex flex-col gap-2 max-w-sm pointer-events-none",document.body.appendChild(this.container)}show(e,t="info",a=3500){const r=document.createElement("div");r.className=`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-lg shadow-xl border text-body-md transition duration-300 translate-y-2 opacity-0 ${t==="success"?"bg-surface-container-high border-status-success/40 text-on-surface":t==="error"?"bg-surface-container-high border-status-error/40 text-on-surface":t==="warning"?"bg-surface-container-high border-status-warning/40 text-on-surface":"bg-surface-container-high border-border text-on-surface"}`;const s={info:"info",success:"check_circle",warning:"warning",error:"error"},i={info:"text-primary",success:"text-status-success",warning:"text-status-warning",error:"text-status-error"};r.innerHTML=`
      <span class="material-symbols-outlined text-[20px] ${i[t]}">${s[t]}</span>
      <span class="flex-1 font-medium">${e}</span>
    `,this.container.appendChild(r),requestAnimationFrame(()=>{r.classList.remove("translate-y-2","opacity-0")}),setTimeout(()=>{r.classList.add("opacity-0","translate-y-2"),setTimeout(()=>r.remove(),300)},a)}}const p=new O;class R{constructor(e){c(this,"game");c(this,"plugins",[]);c(this,"hasBackup",!1);c(this,"modalEl",null);this.game=e}async open(){var e,t,a;this.modalEl=document.createElement("div"),this.modalEl.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 select-none",this.modalEl.innerHTML=`
    ...
    `,document.body.appendChild(this.modalEl),this.modalEl.querySelectorAll(".btn-close").forEach(r=>{r.addEventListener("click",()=>this.close())}),(e=this.modalEl.querySelector("#btn-toggle-all-on"))==null||e.addEventListener("click",()=>this.toggleAll(!0)),(t=this.modalEl.querySelector("#btn-toggle-all-off"))==null||t.addEventListener("click",()=>this.toggleAll(!1)),(a=this.modalEl.querySelector("#btn-restore-plugins"))==null||a.addEventListener("click",()=>this.restoreOriginal()),await this.loadData()}async loadData(){var e;try{const t=await u.getPlugins(this.game.name);this.plugins=t.plugins,this.hasBackup=t.has_backup,this.renderTable()}catch(t){const a=(e=this.modalEl)==null?void 0:e.querySelector("#plugins-table-container");a&&(a.innerHTML=`<div class="p-6 text-center text-status-error">Error al cargar plugins: ${t.message}</div>`)}}renderTable(){var a;const e=(a=this.modalEl)==null?void 0:a.querySelector("#plugins-table-container");if(!e)return;if(this.plugins.length===0){e.innerHTML='<div class="p-6 text-center text-text-muted">No se encontraron plugins en este juego.</div>';return}const t=this.plugins.map((r,s)=>{let i="bg-status-success/15 text-status-success",l="OK";return r.category==="nw-protegido"?(i="bg-status-warning/15 text-status-warning",l="NW PROTECTED"):r.category==="roto"?(i="bg-status-error/15 text-status-error",l="BROKEN"):r.category==="sin-fichero"&&(i="bg-surface-variant text-text-faint",l="MISSING"),`
    ...
    `,e.querySelectorAll(".plugin-toggle").forEach(r=>{r.addEventListener("change",async s=>{const i=s.target,l=parseInt(i.dataset.index||"0",10),d=this.plugins[l],n=i.checked;d.status=n;try{await u.togglePlugins(this.game.name,{names:[d.name],status:n}),p.show(`Plugin ${d.name} ${n?"activado":"desactivado"}`,"success",2e3)}catch(h){p.show(`Error: ${h.message}`,"error"),i.checked=!n,d.status=!n}})})}async toggleAll(e){try{await u.togglePlugins(this.game.name,{all:!0,status:e}),this.plugins.forEach(t=>t.status=e),this.renderTable(),p.show(`Todos los plugins ${e?"activados":"desactivados"}`,"success")}catch(t){p.show(`Error: ${t.message}`,"error")}}async restoreOriginal(){try{await u.togglePlugins(this.game.name,{action:"restore"}),p.show("Plugins restaurados desde la copia original","success"),await this.loadData()}catch(e){p.show(`Error restaurando plugins: ${e.message}`,"error")}}close(){var e;(e=this.modalEl)==null||e.remove(),this.modalEl=null}}class A{constructor(e,t){c(this,"game");c(this,"filename");c(this,"saveContent",null);c(this,"activeTab","general");c(this,"modalEl",null);c(this,"gold",0);c(this,"items",{});c(this,"variables",{});c(this,"switches",{});this.game=e,this.filename=t}async open(){var e;this.modalEl=document.createElement("div"),this.modalEl.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/85 select-none",this.modalEl.innerHTML=`
    ...
    `)}renderTabContent(){var t,a,r,s,i;const e=(t=this.modalEl)==null?void 0:t.querySelector("#editor-tab-content");if(!(!e||!this.saveContent)){if(this.activeTab==="general"){e.innerHTML=`
      ...
      `,e.querySelectorAll(".var-val-input").forEach(d=>{d.addEventListener("change",n=>{const h=n.target,m=h.dataset.id,g=Number(h.value);this.variables[m]=isNaN(g)?h.value:g,this.renderSummary()})})}else if(this.activeTab==="switches"){const l=Object.entries(this.switches);e.innerHTML=`
        <div class="flex flex-col gap-3">
      ...
      `,e.querySelectorAll(".switch-toggle").forEach(d=>{d.addEventListener("change",n=>{const h=n.target,m=h.dataset.id;this.switches[m]=h.checked,this.renderSummary()})})}}}async saveChanges(){try{await u.saveSaveContent(this.game.name,this.filename,{gold:this.gold,items:this.items,variables:this.variables,switches:this.switches}),p.show("Partida guardada con copia de seguridad","success"),this.close()}catch(e){p.show(`Error guardando partida: ${e.message}`,"error")}}close(){var e;(e=this.modalEl)==null||e.remove(),this.modalEl=null}}class z{constructor(e){c(this,"game");c(this,"saves",[]);c(this,"selectedSave",null);c(this,"modalEl",null);this.game=e}async open(){var e,t;this.modalEl=document.createElement("div"),this.modalEl.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 select-none",this.modalEl.innerHTML=`
    ...
    `,document.body.appendChild(this.modalEl),this.modalEl.querySelectorAll(".btn-close").forEach(a=>{a.addEventListener("click",()=>this.close())}),(e=this.modalEl.querySelector("#btn-backup-saves"))==null||e.addEventListener("click",()=>this.createBackup()),(t=this.modalEl.querySelector("#btn-edit-save"))==null||t.addEventListener("click",()=>this.openEditor()),await this.loadData()}async loadData(){var e;try{const t=await u.getSaves(this.game.name);this.saves=t.saves,this.selectedSave=this.saves[0]||null,this.renderTable(),this.updateEditButtonState()}catch(t){const a=(e=this.modalEl)==null?void 0:e.querySelector("#saves-table-container");a&&(a.innerHTML=`<div class="p-6 text-center text-status-error">Error al cargar partidas: ${t.message}</div>`)}}updateEditButtonState(){var t;const e=(t=this.modalEl)==null?void 0:t.querySelector("#btn-edit-save");e&&(e.disabled=!this.selectedSave)}renderTable(){var a;const e=(a=this.modalEl)==null?void 0:a.querySelector("#saves-table-container");if(!e)return;if(this.saves.length===0){e.innerHTML=`
    ...
    `,e.querySelectorAll(".save-row").forEach(r=>{r.addEventListener("click",s=>{const i=s.currentTarget.dataset.name;this.selectedSave=this.saves.find(l=>l.name===i)||null,this.renderTable(),this.updateEditButtonState()}),r.addEventListener("dblclick",()=>{this.openEditor()})})}async createBackup(){try{const e=await u.backupSaves(this.game.name);p.show(`Copia de seguridad creada en snapshot-${e.timestamp}`,"success")}catch(e){p.show(`Error creando copia: ${e.message}`,"error")}}openEditor(){if(!this.selectedSave)return;new A(this.game,this.selectedSave.name).open()}close(){var e;(e=this.modalEl)==null||e.remove(),this.modalEl=null}}class B{constructor(e){c(this,"game");c(this,"currentCategory","Items");c(this,"items",[]);c(this,"searchQuery","");c(this,"modalEl",null);this.game=e}async open(){this.modalEl=document.createElement("div"),this.modalEl.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 select-none",this.modalEl.innerHTML=`
    ...
    `}close(){var e;(e=this.modalEl)==null||e.remove(),this.modalEl=null}}async function N(){const b=prompt("Introduce la ruta de la carpeta de destino de partidas:");return(b==null?void 0:b.trim())||null}class F{constructor(){c(this,"syncData",null);c(this,"modalEl",null);c(this,"folder","")}async open(){var a,r,s,i;this.modalEl=document.createElement("div"),this.modalEl.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 select-none",this.modalEl.innerHTML=`
...
`);try{const i=await u.decrypt(this.selectedGame,(s=t==null?void 0:t.checked)!=null?s:!0);e&&(e.textContent+=`
...
ERROR: ${i.message}`),p.show(`Error descifrando: ${i.message}`,"error")}}close(){var e;(e=this.modalEl)==null||e.remove(),this.modalEl=null}}class I{constructor(){c(this,"config",null);c(this,"modalEl",null)}async open(){var e;this.modalEl=document.createElement("div"),this.modalEl.className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 select-none",this.modalEl.innerHTML=`
    ...
    `,document.body.appendChild(this.modalEl),this.modalEl.querySelectorAll(".btn-close").forEach(t=>{t.addEventListener("click",()=>this.close())}),(e=this.modalEl.querySelector("#btn-save-shortcuts"))==null||e.addEventListener("click",()=>this.saveConfig()),await this.loadConfig()}async loadConfig(){var e;try{this.config=await u.getConfig(),this.renderBody()}catch(t){const a=(e=this.modalEl)==null?void 0:e.querySelector("#shortcuts-body-container");a&&(a.innerHTML=`<div class="text-center text-status-error p-6">Error: ${t.message}</div>`)}}renderBody(){var r;const e=(r=this.modalEl)==null?void 0:r.querySelector("#shortcuts-body-container");if(!e||!this.config)return;const a=[{key:"trucos",label:"Menú de trucos in-game"},{key:"recargar",label:"Recargar juego en visor"},{key:"fps",label:"Mostrar/Ocultar FPS"},{key:"captura",label:"Captura de pantalla"},{key:"pantalla_completa",label:"Pantalla completa"},{key:"zoom_in",label:"Aumentar Zoom"},{key:"zoom_out",label:"Reducir Zoom"}].map(s=>{const i=this.config.teclas[s.key]||"";return`
    ...
    `,document.body.appendChild(this.modalEl),this.modalEl.querySelectorAll(".btn-close, #btn-settings-close").forEach(r=>{r.addEventListener("click",()=>this.close())}),this.modalEl.addEventListener("click",r=>{r.target===this.modalEl&&this.close()});const e=this.modalEl.querySelector("#input-games-folder");e==null||e.addEventListener("change",()=>{this.folder=e.value.trim(),this.persistFolder(),this.updateFolderUi()}),(t=this.modalEl.querySelector("#btn-pick-folder"))==null||t.addEventListener("click",async()=>{try{const r=await V();if(!r)return;this.folder=r,e&&(e.value=r),await this.persistFolder(),this.updateFolderUi()}catch(r){p.show(`${o("settingsTitle")}: ${r.message}`,"error")}}),(a=this.modalEl.querySelector("#btn-open-folder"))==null||a.addEventListener("click",async()=>{if(this.folder)try{await u.openTarget(this.folder)}catch(r){p.show(`${o("settingsTitle")}: ${r.message}`,"error")}}),await this.loadData(),this.updateFolderUi()}updateFolderUi(){if(!this.modalEl)return;const e=!!this.folder,t=this.modalEl.querySelector("#btn-open-folder");t.disabled=!e}async persistFolder(){try{const e=await u.getConfig();e.general={...e.general,games_dir:this.folder},await u.updateConfig(e),p.show("Carpeta de juegos guardada","info",2e3),await this.loadData(),this.updateFolderUi()}catch(e){p.show(`Error al guardar carpeta: ${e.message}`,"error")}}async loadData(){var e,t;try{const a=await u.getConfig();this.folder=(((e=a.general)==null?void 0:e.games_dir)||"").trim();const r=(t=this.modalEl)==null?void 0:t.querySelector("#input-games-folder");r&&(r.value=this.folder),await this.renderPlaceholder()}catch(a){p.show(`Error al cargar config: ${a.message}`,"error")}}async renderPlaceholder(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#input-games-folder");if(!e)return;const{api:t}=await J(async()=>{const{api:r}=await Promise.resolve().then(()=>D);return{api:r}},void 0),a=t.getBaseUrl().replace("/api","")+"/games";e.placeholder=o("settingsDefaultFolder",a)}close(){var e;(e=this.modalEl)==null||e.remove(),this.modalEl=null}}class K{constructor(e){c(this,"games",[]);c(this,"selectedGame",null);c(this,"searchQuery","");c(this,"activeGame",null);c(this,"activePort",null);c(this,"cardMap",new Map);c(this,"sidebar");c(this,"header");c(this,"actionBar");c(this,"statusBar");c(this,"appRoot");this.appRoot=e}async init(){var a,r,s,i,l,d;this.appRoot.className="flex h-screen overflow-hidden bg-background text-on-background select-none",this.sidebar=new q({onNav:n=>this.handleNav(n)});let e=!0,t=!1;try{const n=await u.getConfig();e=n.general.webkit!==!1,t=!!n.general.auto_delete_zip,(n.general.lang==="en"||n.general.lang==="es")&&y(n.general.lang)}catch{}this.header=new P({onSearch:n=>this.handleSearch(n),onRefresh:()=>this.handleRefresh(),onLanguageChange:n=>this.handleLanguageChange(n),onToggleWebKit:n=>this.persistGeneralConfig({webkit:n}),onToggleDelZip:n=>this.persistGeneralConfig({auto_delete_zip:n}),onUpdateClick:()=>this.handleOpenReleases(),onSettingsClick:()=>this.handleOpenSettings()},e,t),this.actionBar=new M({onPlay:()=>this.handlePlaySelected(),onPlugins:()=>this.handleOpenPlugins(),onSaves:()=>this.handleOpenSaves(),onData:()=>this.handleOpenData(),onMods:()=>this.handleOpenMods(),onSync:()=>this.handleOpenSync(),onDecrypt:()=>this.handleOpenDecrypt(),onStopServer:()=>this.handleStopServer(),onShortcuts:()=>this.handleOpenShortcuts(),onQuit:()=>window.close()}),this.statusBar=new _;try{const n=await u.getVersion();(r=(a=this.header).setVersion)==null||r.call(a,n),this.statusBar.setVersion(n)}catch{}this.appRoot.innerHTML=`
    ...
    `,(s=this.appRoot.querySelector("#sidebar-slot"))==null||s.appendChild(this.sidebar.render()),(i=this.appRoot.querySelector("#header-slot"))==null||i.appendChild(this.header.render()),(l=this.appRoot.querySelector("#actionbar-slot"))==null||l.appendChild(this.actionBar.render()),(d=this.appRoot.querySelector("#statusbar-slot"))==null||d.appendChild(this.statusBar.render()),this.setupDragAndDrop(),u.listenEvents({onProgress:n=>{p.show(`Extrayendo: ${n.filename} (${n.current}/${n.total})`,"info",2e3)},onServerStarted:n=>{this.activeGame=n.game,this.activePort=n.port,this.updateBars(),p.show(o("toastServerStarted",n.port),"success")},onServerStopped:n=>{this.activeGame=null,this.activePort=null,this.updateBars(),n.game&&(p.show(o("toastServerStopped",n.seconds_added),"info"),this.loadGames())},onSyncComplete:n=>{p.show(`Sincronización de ${n.game} completada`,"success")},onGameLaunched:n=>{p.show(`${n.engine==="renpy"?"Ren'Py":"Juego nativo"} lanzado: abriendo ventana...`,"info",4e3)}}),await this.loadStatus(),await this.loadGames(),u.checkUpdate().then(n=>{n.update_available&&n.tag_name&&(this.header.setUpdateTag(n.tag_name),p.show(`Nueva versión disponible: ${n.tag_name}`,"info",5e3))}).catch(()=>{})}setupDragAndDrop(){const e=this.appRoot.querySelector("#drag-drop-overlay"),t=r=>e==null?void 0:e.classList.toggle("hidden",!r);let a=0;window.addEventListener("dragenter",r=>{r.preventDefault(),a++,t(!0)}),window.addEventListener("dragleave",r=>{r.preventDefault(),a--,a<=0&&(t(!1),a=0)}),window.addEventListener("dragover",r=>{r.preventDefault()}),window.addEventListener("drop",async r=>{r.preventDefault(),a=0,t(!1),await this.handleRefresh()})}async handleDroppedPaths(e){const t=e.filter(a=>a.toLowerCase().endsWith(".zip"));if(t.length===0){p.show(o("dragDropZip"),"warning");return}try{p.show(`Copiando ${t.length} .zip y extrayendo...`,"info");const a=await u.getConfig(),r=await u.installZips(t,a.general.auto_delete_zip);for(const s of r.extracted)p.show(`Extraído: ${s}`,"success");for(const s of r.skipped)p.show(s,"error");r.extracted.length===0&&r.skipped.length===0&&p.show("Sin nuevos archivos .zip","info"),this.games=r.games,this.renderGrid(),this.updateSubtitle()}catch(a){p.show(`Error al instalar: ${a.message}`,"error")}}async loadStatus(){try{const e=await u.getStatus();this.activeGame=e.active_game,this.activePort=e.port,this.updateBars()}catch{}}async loadGames(){try{const e=await u.getGames();this.games=e.games,this.selectedGame?this.selectedGame=this.games.find(t=>{var a;return t.name===((a=this.selectedGame)==null?void 0:a.name)})||this.games[0]||null:this.games.length>0&&(this.selectedGame=this.games[0]),this.renderGrid(),this.updateSubtitle(),this.updateBars()}catch(e){p.show(`Error al cargar juegos: ${e.message}`,"error")}}updateSubtitle(){const e=this.appRoot.querySelector("#library-subtitle");e&&(e.textContent=`${this.games.length} ${o("gamesInstalled")}`)}updateBars(){const e=!!(this.activeGame&&this.activePort);this.actionBar.update(this.selectedGame,e),this.statusBar.update(this.activeGame,this.activePort);const t=this.appRoot.querySelector("#actionbar-slot");t&&(t.innerHTML="",t.appendChild(this.actionBar.render()));const a=this.appRoot.querySelector("#statusbar-slot");a&&(a.innerHTML="",a.appendChild(this.statusBar.render()))}renderGrid(){const e=this.appRoot.querySelector("#games-grid");if(!e)return;e.innerHTML="",this.cardMap.clear();const t=this.games.filter(a=>this.searchQuery?a.name.toLowerCase().includes(this.searchQuery)||a.engine.toLowerCase().includes(this.searchQuery):!0);if(t.length===0){e.innerHTML=`
      ...
      `;return}t.forEach(a=>{var l;const r=((l=this.selectedGame)==null?void 0:l.name)===a.name,s=new j(a,r,{onSelect:d=>this.selectGame(d),onLaunch:d=>{this.launchGame(d)},onFavorite:async(d,n)=>{try{const h=!d.favorite;await u.toggleFavorite(d.name,h),d.favorite=h,this.loadGames()}catch(h){p.show(`Error: ${h.message}`,"error")}}}),i=s.render();this.cardMap.set(a.name,{card:s,el:i}),e.appendChild(i)})}selectGame(e){var a,r,s;if(((a=this.selectedGame)==null?void 0:a.name)===e.name)return;const t=this.selectedGame;this.selectedGame=e,t&&((r=this.cardMap.get(t.name))==null||r.card.setSelected(!1)),(s=this.cardMap.get(e.name))==null||s.card.setSelected(!0),this.updateBars()}async launchGame(e){if(e.is_incomplete){p.show(o("incompleteNotice"),"warning");return}try{const a=(await u.getConfig()).general.webkit?"webkit":"browser";p.show(`Iniciando ${e.name}...`,"info"),await u.launchGame(e.name,a)}catch(t){p.show(`No se pudo lanzar '${e.name}': ${t.message}`,"error")}}handleSearch(e){this.searchQuery=e.toLowerCase().trim(),this.renderGrid()}async handleRefresh(){try{p.show("Buscando y extrayendo nuevos .zip...","info");const e=await u.getConfig(),t=await u.rescan(e.general.auto_delete_zip);t.extracted.length>0?p.show(`Extraídos: ${t.extracted.join(", ")}`,"success"):p.show("Sin nuevos archivos .zip","info"),this.loadGames()}catch(e){p.show(`Error al actualizar: ${e.message}`,"error")}}async handleLanguageChange(e){y(e),this.persistGeneralConfig({lang:e}),this.appRoot.innerHTML="",await this.init()}async persistGeneralConfig(e){try{const t=await u.getConfig();t.general={...t.general,...e},await u.updateConfig(t)}catch(t){p.show(`No se pudo guardar la preferencia: ${t.message}`,"error")}}handleOpenReleases(){u.openTarget("https://github.com/AsterrZep/rpgmaker-launcher/releases").catch(e=>p.show(`Error al abrir releases: ${e.message}`,"error"))}async handleOpenMods(){if(!this.selectedGame){p.show("Selecciona un juego primero","warning");return}try{const e=await u.setupMods(this.selectedGame.name);await u.openTarget(e.mods_dir),p.show(o("modsReadyToast"),"success")}catch(e){p.show(`Error con mods: ${e.message}`,"error")}}handlePlaySelected(){this.selectedGame&&this.launchGame(this.selectedGame)}async handleStopServer(){try{await u.stopServer()}catch(e){p.show(`Error al detener servidor: ${e.message}`,"error")}}handleNav(e){switch(e){case"library":break;case"plugins":this.handleOpenPlugins();break;case"saves":this.handleOpenSaves();break;case"data":this.handleOpenData();break;case"sync":this.handleOpenSync();break;case"decrypt":this.handleOpenDecrypt();break;case"shortcuts":this.handleOpenShortcuts();break}}handleOpenPlugins(){if(!this.selectedGame){p.show("Selecciona un juego primero","warning");return}new R(this.selectedGame).open()}handleOpenSaves(){if(!this.selectedGame){p.show("Selecciona un juego primero","warning");return}new z(this.selectedGame).open()}handleOpenData(){if(!this.selectedGame){p.show("Selecciona un juego primero","warning");return}new B(this.selectedGame).open()}handleOpenSync(){new F().open()}handleOpenDecrypt(){new H(this.games,this.selectedGame).open()}handleOpenShortcuts(){new I().open()}handleOpenSettings(){new Z().open()}}window.addEventListener("DOMContentLoaded",async()=>{const b=document.getElementById("app");b&&await new K(b).init()});
